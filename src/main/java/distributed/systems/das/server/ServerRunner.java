...
//                        .createTSS ();
        ...
        broker.registerListener(Event.ATTACK, localGameState);
        broker.registerListener(Event.HEAL, localGameState);
        broker.registerListener(Event.MOVE, localGameState);
        broker.registerListener(Event.LOGIN, localGameState);
        broker.registerListener(Event.HEARTBEAT, heartbeatService);
